package com.example.application.views.legaldepartment;
...
@PageTitle("Legal Department")
@Route(value = "legal", layout = MainLayout.class)
@PermitAll
public class LegalDepartmentView extends VerticalLayout {

    public LegalDepartmentView() {
        addClassName("legal-department-view");
        setSpacing(false);
