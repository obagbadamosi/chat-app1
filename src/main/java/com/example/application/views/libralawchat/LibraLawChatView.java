package com.example.application.views.libralawchat;
...
@PageTitle("LibraLaw Chat")
@Route(value = "chat", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@PermitAll
public class LibraLawChatView extends VerticalLayout {

    public LibraLawChatView() {
        addClassName("libra-law-chat-view");
        setSpacing(false);
